      ...
      <div className="booking-success__card">
          ...
          <div className="booking-success__trip-grid">
            ...
            <div className="booking-success__trip-row">
              ...
              <div>
                ...
                <span className="booking-success__trip-val">
        ...
        <div className="booking-success__next-steps">
          ...
          <ul className="booking-success__steps-list">
            <li>
              📱 Tài xế sẽ liên hệ trước <strong>30 phút</strong> khi đến điểm đón
            </li>
            <li>🎫 Mang theo CMND/CCCD hoặc căn cước khi lên xe</li>
            <li>
              ⏰ Có mặt tại điểm đón trước <strong>15 phút</strong> giờ khởi hành
            </li>
            <li>
              📞 Hotline hỗ trợ: <strong>1900 1234</strong> (24/7)
            </li>
          </ul>
        </div>
        ...
        <div className="booking-success__actions">
          ...
          <button className="booking-success__btn-home" onClick={() => navigate('/')} type="button">
            <FiHome /> Về trang chủ
          </button>
        </div>

        <div className="booking-success__register-hint">
          <p>Tạo tài khoản để quản lý vé, tích điểm và nhận ưu đãi độc quyền!</p>
          <button className="booking-success__register-btn" type="button" onClick={onRegister}>
